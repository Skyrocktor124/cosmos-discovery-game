        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-slate-950/60 backdrop-blur-[2px]">
          ...
          {phase === 'over' ? (
            <div className="text-center flex flex-col items-center gap-3">
              ...
              <ShareButton text={`I scored ${score} in Orbit Dash 🛰️ Can you beat it?`} />
            </div>
          ) : (
          ...
          <div className="flex gap-4 text-xs text-slate-500 uppercase font-bold mt-2">
            ...
            <a href="../star-serpent/" className="hover:text-amber-300 transition-colors pointer-events-auto" onPointerDown={e => e.stopPropagation()}>▶ Star Serpent</a>
            <a href="../forest-spirit/" className="hover:text-emerald-300 transition-colors pointer-events-auto" onPointerDown={e => e.stopPropagation()}>▶ Forest Spirit Run</a>
          </div>
        </div>
      )}
    </div>
